            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        ...
                        <li><a href="../fraccionamiento/">7-2 - Ingreso Bolsa</a></li>
                        <li><a href="../fraccionamiento/">7-3 - Plasma</a></li>
                        <li><a href="../fraccionamiento/">7-4 - Plaqueta</a></li>
                        <li><a href="../fraccionamiento/">7-5 - Globulo</a></li>
                        <li><a href="../fraccionamiento/">7-6 - Criopresipitado</a></li>
                    </ul>
                </li>
                <li class="dropdown">
