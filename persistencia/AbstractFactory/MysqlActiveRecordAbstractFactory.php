<?php
/**
* Archivo de la clase MysqlActiveRecordAbstractFactory.
* Archivo de la clase MysqlActiveRecordAbstractFactory que nos
* permite conectar al servidor Mysql y tambin podremos crear
